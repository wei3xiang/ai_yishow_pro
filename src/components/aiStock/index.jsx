...
const Index = () => {
        ...
        layero.find("#modalOk").on("click", () => {
          const updatedItem = {
            ...aiStock,
              ...
              aiStockLevel: layero.find('input[name="aiStockLevel"]').val(), 
          };
          setList(
  ...
  const handleCreate = () => {
    const newItem = { uuid: "",  aiProductId: "",  aiTotal: "",  aiStockLevel: "", };
    ...
    layui.layer.open({
      ...
      success: function (layero, index) {
        ...
        layero.find("#modalOk").on("click", () => {
          ...
          const aiStockLevel = layero.find('input[name="aiStockLevel"]').val();
           if (
           aiProductId &&
