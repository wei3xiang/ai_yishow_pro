...
import { aiProductInfoStateAtom } from './atom';

const SearchForm = (props) => {
  const [form] = Form.useForm();
  const [aiProductInfoState, setAiProductInfoState] = useRecoilState(aiProductInfoStateAtom);
  ...
  const onClickToCreate = useCallback(() => {
    setAiProductInfoState((prevState) => ({
      ...prevState,
      createModel: {},
    }));
  }, []);
