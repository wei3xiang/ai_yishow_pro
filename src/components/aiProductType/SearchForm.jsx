...
import { aiProductTypeStateAtom } from './atom';

const SearchForm = (props) => {
  const [form] = Form.useForm();
  const [aiProductTypeState, setAiProductTypeState] = useRecoilState(aiProductTypeStateAtom);
  ...
  const onClickToCreate = useCallback(() => {
    setAiProductTypeState((prevState) => ({
      ...prevState,
      createModel: {},
    }));
  }, []);
