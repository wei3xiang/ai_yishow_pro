...
const Index = () => {
        ...
        layero.find("#modalOk").on("click", () => {
          const updatedItem = {
            ...aiOrder,
              ...
              aiCustomerId: layero.find('input[name="aiCustomerId"]').val(), 
  ...
  const handleCreate = () => {
    const newItem = { uuid: "",  aiOrderNumber: "",  aiCustomerId: "",  aiOrderStatus: "",  aiOrderDate: "", };
    ...
    layui.layer.open({
      ...
      success: function (layero, index) {
        ...
        layero.find("#modalOk").on("click", () => {
          ...
          const aiCustomerId = layero.find('input[name="aiCustomerId"]').val();
          const aiOrderStatus = layero.find('input[name="aiOrderStatus"]').val();
          const aiOrderDate = layero.find('input[name="aiOrderDate"]').val();
          setList([...list, { ...newItem, uuid: Date.now(), aiOrderNumber,aiCustomerId,aiOrderStatus,aiOrderDate, }]);
          layui.layer.close(index);
        });
      },
    });
