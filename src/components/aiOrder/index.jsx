...
const Index = () => {
  ...
  const handleCreate = () => {
    const newItem = { uuid: "",  aiUserUuid: "",  aiProductName: "",  aiQuantity: "",  aiOrderDate: "",  aiStatus: "", };
    ...
    layui.layer.open({
      ...
      success: function (layero, index) {
        ...
        layero.find("#modalOk").on("click", () => {
          ...
          setList([...list, { ...newItem, uuid: Date.now(), aiUserUuid,aiProductName,aiQuantity,aiOrderDate,aiStatus, }]);
          layui.layer.close(index);
        });
      },
    });
