...
const Index = () => {
  ...
  const handleCreate = () => {
    const newItem = { uuid: "",  aiUserUuid: "",  aiOrderNumber: "",  aiOrderDate: "",  aiTotalAmount: "",  aiOrderStatus: "",  aiPaymentMethod: "",  aiCreationTime: "", };
    ...
    layui.layer.open({
      ...
      success: function (layero, index) {
        ...
        layero.find("#modalOk").on("click", () => {
          ...
          setList([...list, { ...newItem, uuid: Date.now(), aiUserUuid,aiOrderNumber,aiOrderDate,aiTotalAmount,aiOrderStatus,aiPaymentMethod,aiCreationTime, }]);
          layui.layer.close(index);
        });
      },
    });
