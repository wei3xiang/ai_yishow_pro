...
const Index = () => {
  ...
  const handleCreate = () => {
    const newItem = { uuid: "",  aiUserUuid: "",  aiOrderNumber: "",  aiOrderStatus: "",  aiOrderTotal: "", };
    ...
    layui.layer.open({
      ...
      success: function (layero, index) {
        ...
        layero.find("#modalOk").on("click", () => {
          ...
          setList([...list, { ...newItem, uuid: Date.now(), aiUserUuid,aiOrderNumber,aiOrderStatus,aiOrderTotal, }]);
          layui.layer.close(index);
        });
      },
    });
