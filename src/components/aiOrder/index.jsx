...
const Index = () => {
  ...
  const handleCreate = () => {
    const newItem = { uuid: "",  aiUserId: "",  aiProductName: "",  aiQuantity: "",  aiOrderDate: "",  aiTotalAmount: "", };
    ...
    layui.layer.open({
      ...
      success: function (layero, index) {
        ...
        layero.find("#modalOk").on("click", () => {
          ...
          setList([...list, { ...newItem, uuid: Date.now(), aiUserId,aiProductName,aiQuantity,aiOrderDate,aiTotalAmount, }]);
          layui.layer.close(index);
        });
      },
    });
