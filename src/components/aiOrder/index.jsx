...
const Index = () => {
  ...
  const handleCreate = () => {
    const newItem = { uuid: "",  aiCustomerUuid: "",  aiOrderNumber: "",  aiTotalAmount: "",  aiOrderDate: "",  aiOrderStatus: "", };
    ...
    layui.layer.open({
      ...
      success: function (layero, index) {
        ...
        layero.find("#modalOk").on("click", () => {
          ...
          setList([...list, { ...newItem, uuid: Date.now(), aiCustomerUuid,aiOrderNumber,aiTotalAmount,aiOrderDate,aiOrderStatus, }]);
          layui.layer.close(index);
        });
      },
    });
