...
const Index = () => {
  ...
  const handleCreate = () => {
    const newItem = { uuid: "",  aiProductUuid: "",  aiUserUuid: "",  aiOrderNumber: "",  aiOrderDate: "",  aiQuantity: "",  aiTotalPrice: "", };
    ...
    layui.layer.open({
      ...
      success: function (layero, index) {
        ...
        layero.find("#modalOk").on("click", () => {
          ...
          setList([...list, { ...newItem, uuid: Date.now(), aiProductUuid,aiUserUuid,aiOrderNumber,aiOrderDate,aiQuantity,aiTotalPrice, }]);
          layui.layer.close(index);
        });
      },
    });
