...
const Index = () => {
  ...
  const handleCreate = () => {
    const newItem = { uuid: "",  aiUserId: "",  aiFlowerId: "",  aiOrderDate: "",  aiQuantity: "",  aiTotalPrice: "", };
    ...
    layui.layer.open({
      ...
      success: function (layero, index) {
        ...
        layero.find("#modalOk").on("click", () => {
          ...
          setList([...list, { ...newItem, uuid: Date.now(), aiUserId,aiFlowerId,aiOrderDate,aiQuantity,aiTotalPrice, }]);
          layui.layer.close(index);
        });
      },
    });
