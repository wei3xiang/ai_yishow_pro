...
const Index = () => {
  ...
  const handleCreate = () => {
    const newItem = { uuid: "",  aiCustomerUuid: "",  aiShopUuid: "",  aiOrderDate: "",  aiTotalPrice: "", };
    ...
    layui.layer.open({
      ...
      success: function (layero, index) {
        ...
        layero.find("#modalOk").on("click", () => {
          ...
          setList([...list, { ...newItem, uuid: Date.now(), aiCustomerUuid,aiShopUuid,aiOrderDate,aiTotalPrice, }]);
          layui.layer.close(index);
        });
      },
    });
