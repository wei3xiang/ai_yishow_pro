const UpdateForm = ({ aiOrder }) => {
  return `<div class="layui-form" style="padding: 20px;">
      ...
      <div class="layui-input-block">  
        <input type="text" name="aiProductId" value="${aiOrder.aiProductId}" class="layui-input">  
      </div>  
    </div>  
      <div class="layui-form-item">  
      <label class="layui-form-label">订购数量</label>  
      <div class="layui-input-block">  
        <input type="text" name="aiOrderAmount" value="${aiOrder.aiOrderAmount}" class="layui-input">  
      </div>  
    </div>  
      <div class="layui-form-item">  
