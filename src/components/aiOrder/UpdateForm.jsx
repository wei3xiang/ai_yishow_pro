const UpdateForm = ({ aiOrder }) => {
  return `<div class="layui-form" style="padding: 20px;">
      ...
      <div class="layui-input-block">  
        <input type="text" name="aiOrderId" value="${aiOrder.ai_order_id}" class="layui-input">  
      </div>  
    </div>  
      <div class="layui-form-item">  
      ...
      <div class="layui-input-block">  
        <input type="text" name="aiProductType" value="${aiOrder.ai_product_type}" class="layui-input">  
      </div>  
    </div>  
      <div class="layui-form-item">  
      <label class="layui-form-label">单位</label>  
      <div class="layui-input-block">  
        <input type="text" name="aiUnit" value="${aiOrder.ai_unit}" class="layui-input">  
      </div>  
    </div>  
      <div class="layui-form-item">  
      <label class="layui-form-label">数量</label>  
      <div class="layui-input-block">  
        <input type="text" name="aiNumber" value="${aiOrder.ai_number}" class="layui-input">  
      </div>  
    </div>  
      <div class="layui-form-item">  
