const CreateForm = () => {
  return `  
      <div class="layui-form" style="padding: 20px;">  
            ...
            <div class="layui-input-block">  
                <input type="text" name="ai_customer_uuid" placeholder="请输入客户 UUID"  class="layui-input">  
            </div>  
            </div>  
            <div class="layui-form-item">  
            <label class="layui-form-label">店铺 UUID</label>  
            <div class="layui-input-block">  
                <input type="text" name="ai_shop_uuid" placeholder="请输入店铺 UUID"  class="layui-input">  
            </div>  
            </div>  
            <div class="layui-form-item">  
            <label class="layui-form-label">订单总金额</label>  
            <div class="layui-input-block">  
                <input type="text" name="ai_order_total" placeholder="请输入订单总金额"  class="layui-input">  
            </div>  
            </div>  
            <div class="layui-form-item">  
