  ...
  return `  
      <div class="layui-form" style="padding: 20px;">  
            ...
            <div class="layui-input-block">  
                <input type="text" name="customer_uuid" placeholder="请输入客户UUID"  class="layui-input">  
            </div>  
            </div>  
            <div class="layui-form-item">  
            ...
            <div class="layui-input-block">  
                <input type="text" name="total_cost" placeholder="请输入订单总价"  class="layui-input">  
            </div>  
            </div>  
            <div class="layui-form-item">  
            ...
            <div class="layui-input-block">  
                <input type="text" name="delivery_date" placeholder="请输入预计送达日期"  class="layui-input">  
            </div>  
            </div>  
            <div class="layui-form-item">  
