  ...
  return `  
      <div class="layui-form" style="padding: 20px;">  
          ...
          <div class="layui-form-item">  
            ...
            <div class="layui-input-block">  
              <input type="text" name="aiCustomerName" value="${aiOrder.ai_customer_name}" class="layui-input" readonly>  
            </div>  
          </div>  
          <div class="layui-form-item">  
          ...
          <div class="layui-form-item">  
            ...
            <div class="layui-input-block">  
              <input type="text" name="aiRoomId" value="${aiOrder.ai_room_id}" class="layui-input" readonly>  
            </div>  
          </div>  
          <div class="layui-form-item">  
            <label class="layui-form-label">关联员工ID</label>  
            <div class="layui-input-block">  
              <input type="text" name="aiEmployeeId" value="${aiOrder.ai_employee_id}" class="layui-input" readonly>  
            </div>  
          </div>  
      </div>  
