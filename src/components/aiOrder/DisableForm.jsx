      ...
      <div class="layui-form" style="padding: 20px;">  
          <div class="layui-form-item">  
            ...
            <div class="layui-input-block">  
              <input type="text" name="aiOrderId" value="${aiOrder.aiOrderId}" class="layui-input" readonly>  
            </div>  
          </div>  
          <div class="layui-form-item">  
          ...
          <div class="layui-form-item">  
            ...
            <div class="layui-input-block">  
              <input type="text" name="aiOrderTotal" value="${aiOrder.aiOrderTotal}" class="layui-input" readonly>  
            </div>  
          </div>  
      </div>  
