...
import { aiProductCategoryStateAtom } from './atom';

const SearchForm = (props) => {
  const [form] = Form.useForm();
  const [aiProductCategoryState, setAiProductCategoryState] = useRecoilState(aiProductCategoryStateAtom);
  ...
  const onClickToCreate = useCallback(() => {
    setAiProductCategoryState((prevState) => ({
      ...prevState,
      createModel: {},
    }));
  }, []);
