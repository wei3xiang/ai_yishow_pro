...
const Index = () => {
        ...
        layero.find("#modalOk").on("click", () => {
          const updatedItem = {
            ...aiUser,
              ...
              aiEmailConfirmed: layero.find('input[name="aiEmailConfirmed"]').val(), 
              aiRegisteredAt: layero.find('input[name="aiRegisteredAt"]').val(), 
              aiLastLoginAt: layero.find('input[name="aiLastLoginAt"]').val(), 
          };
          setList(
  ...
  const handleCreate = () => {
    const newItem = { uuid: "",  aiUsername: "",  aiPassword: "",  aiEmail: "",  aiPhone: "",  aiAddress: "",  aiEmailConfirmed: "",  aiRegisteredAt: "",  aiLastLoginAt: "", };
    ...
    layui.layer.open({
      ...
      success: function (layero, index) {
        ...
        layero.find("#modalOk").on("click", () => {
          ...
          const aiEmailConfirmed = layero.find('input[name="aiEmailConfirmed"]').val();
          const aiRegisteredAt = layero.find('input[name="aiRegisteredAt"]').val();
          const aiLastLoginAt = layero.find('input[name="aiLastLoginAt"]').val();
           if (aiUsername && aiPassword && aiEmail && aiPhone && aiAddress && aiEmailConfirmed && aiRegisteredAt && aiLastLoginAt
           ) {
