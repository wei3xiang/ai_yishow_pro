  ...
  return `  
      <div class="layui-form" style="padding: 20px;">  
        ...
        <div class="layui-form-item">  
          ...
          <div class="layui-input-block">  
            <input type="text" value="${aiUser.ai_email_confirmed}" class="layui-input" readonly>  
          </div>  
        </div>
        <div class="layui-form-item">  
          <label class="layui-form-label">注册时间</label>  
          <div class="layui-input-block">  
            <input type="text" value="${aiUser.ai_registered_at}" class="layui-input" readonly>  
          </div>  
        </div>
        <div class="layui-form-item">  
          <label class="layui-form-label">上次登录时间</label>  
          <div class="layui-input-block">  
            <input type="text" value="${aiUser.ai_last_login_at}" class="layui-input" readonly>  
          </div>  
        </div>
        </div>
