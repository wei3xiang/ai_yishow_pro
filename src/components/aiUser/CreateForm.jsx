const CreateForm = () => {
  return `  
      <div class="layui-form" style="padding: 20px;">  
            ...
            <div class="layui-input-block">  
                <input type="text" name="ai_email_confirmed" placeholder="请输入邮箱已验证状态"  class="layui-input">  
            </div>  
            </div>  
            <div class="layui-form-item">  
            <label class="layui-form-label">注册时间</label>  
            <div class="layui-input-block">  
                <input type="text" name="ai_registered_at" placeholder="请输入注册时间"  class="layui-input">  
            </div>  
            </div>  
            <div class="layui-form-item">  
            <label class="layui-form-label">上次登录时间</label>  
            <div class="layui-input-block">  
                <input type="text" name="ai_last_login_at" placeholder="请输入上次登录时间"  class="layui-input">  
            </div>  
            </div>  
      </div>  
