...
import { aiFlowerOrderStateAtom } from './atom';

const SearchForm = (props) => {
  const [form] = Form.useForm();
  const [aiFlowerOrderState, setAiFlowerOrderState] = useRecoilState(aiFlowerOrderStateAtom);
  ...
  const onClickToCreate = useCallback(() => {
    setAiFlowerOrderState((prevState) => ({
      ...prevState,
      createModel: {},
    }));
  }, []);
