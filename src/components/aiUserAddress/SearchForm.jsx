...
import { aiUserAddressStateAtom } from './atom';

const SearchForm = (props) => {
  const [form] = Form.useForm();
  const [aiUserAddressState, setAiUserAddressState] = useRecoilState(aiUserAddressStateAtom);
  ...
  const onClickToCreate = useCallback(() => {
    setAiUserAddressState((prevState) => ({
      ...prevState,
      createModel: {},
    }));
  }, []);
