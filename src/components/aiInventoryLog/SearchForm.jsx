...
import { aiInventoryLogStateAtom } from './atom';

const SearchForm = (props) => {
  const [form] = Form.useForm();
  const [aiInventoryLogState, setAiInventoryLogState] = useRecoilState(aiInventoryLogStateAtom);
  ...
  const onClickToCreate = useCallback(() => {
    setAiInventoryLogState((prevState) => ({
      ...prevState,
      createModel: {},
    }));
  }, []);
