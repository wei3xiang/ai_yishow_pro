...
import { aiProductCategoriesStateAtom } from './atom';

const SearchForm = (props) => {
  const [form] = Form.useForm();
  const [aiProductCategoriesState, setAiProductCategoriesState] = useRecoilState(aiProductCategoriesStateAtom);
  ...
  const onClickToCreate = useCallback(() => {
    setAiProductCategoriesState((prevState) => ({
      ...prevState,
      createModel: {},
    }));
  }, []);
