...
import { aiOperationLogStateAtom } from './atom';

const SearchForm = (props) => {
  const [form] = Form.useForm();
  const [aiOperationLogState, setAiOperationLogState] = useRecoilState(aiOperationLogStateAtom);
  ...
  const onClickToCreate = useCallback(() => {
    setAiOperationLogState((prevState) => ({
      ...prevState,
      createModel: {},
    }));
  }, []);
