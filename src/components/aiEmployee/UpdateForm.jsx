const UpdateForm = ({ aiEmployee }) => {
  return `<div class="layui-form" style="padding: 20px;">
      ...
      <div class="layui-input-block">  
        <input type="text" name="aiEmployeeNumber" value="${aiEmployee.ai_employee_number}" class="layui-input">  
      </div>  
    </div>  
      <div class="layui-form-item">  
      ...
      <div class="layui-input-block">  
        <input type="text" name="aiTitle" value="${aiEmployee.ai_title}" class="layui-input">  
      </div>  
    </div>  
      <div class="layui-form-item">  
      ...
      <div class="layui-input-block">  
        <input type="text" name="aiShopNumber" value="${aiEmployee.ai_shop_number}" class="layui-input">  
      </div>  
    </div>  
  </div>  
