...
import { aiOrderStatusStateAtom } from './atom';

const SearchForm = (props) => {
  const [form] = Form.useForm();
  const [aiOrderStatusState, setAiOrderStatusState] = useRecoilState(aiOrderStatusStateAtom);
  ...
  const onClickToCreate = useCallback(() => {
    setAiOrderStatusState((prevState) => ({
      ...prevState,
      createModel: {},
    }));
  }, []);
