...
import { aiStockPickingStateAtom } from './atom';

const SearchForm = (props) => {
  const [form] = Form.useForm();
  const [aiStockPickingState, setAiStockPickingState] = useRecoilState(aiStockPickingStateAtom);
  ...
  const onClickToCreate = useCallback(() => {
    setAiStockPickingState((prevState) => ({
      ...prevState,
      createModel: {},
    }));
  }, []);
