  ...
  return `  
      <div class="layui-form" style="padding: 20px;">  
          ...
          <div class="layui-form-item">  
            ...
            <div class="layui-input-block">  
              <input type="text" name="aiFlowerImage" value="${aiFlower.ai_flower_image}" class="layui-input" readonly>  
            </div>  
          </div>  
          <div class="layui-form-item">  
            <label class="layui-form-label">花产品分类</label>  
            <div class="layui-input-block">  
              <input type="text" name="aiFlowerCategory" value="${aiFlower.ai_flower_category}" class="layui-input" readonly>  
            </div>  
          </div>  
      </div>  
