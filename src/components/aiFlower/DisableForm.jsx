  ...
  return `  
      <div class="layui-form" style="padding: 20px;">  
          ...
          <div class="layui-form-item">  
            ...
            <div class="layui-input-block">  
              <input type="text" name="aiFlowerImgUrl" value="${aiFlower.ai_flower_img_url}" class="layui-input" readonly>  
            </div>  
          </div>  
          <div class="layui-form-item">  
            <label class="layui-form-label">库存数量</label>  
            <div class="layui-input-block">  
              <input type="text" name="aiStockQuantity" value="${aiFlower.ai_stock_quantity}" class="layui-input" readonly>  
            </div>  
          </div>  
      </div>  
