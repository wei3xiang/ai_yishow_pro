...
const Index = () => {
        ...
        layero.find("#modalOk").on("click", () => {
          const updatedItem = {
            ...aiFlower,
              ...
              aiFlowerStock: layero.find('input[name="aiFlowerStock"]').val(), 
          };
          setList(
  ...
  const handleCreate = () => {
    const newItem = { uuid: "",  aiFlowerName: "",  aiFlowerType: "",  aiFlowerPrice: "",  aiFlowerStock: "", };
    ...
    layui.layer.open({
      ...
      success: function (layero, index) {
        ...
        layero.find("#modalOk").on("click", () => {
          ...
          const aiFlowerStock = layero.find('input[name="aiFlowerStock"]').val();
          setList([...list, { ...newItem, uuid: Date.now(), aiFlowerName,aiFlowerType,aiFlowerPrice,aiFlowerStock, }]);
          layui.layer.close(index);
        });
      },
    });
