...
const Index = () => {
        ...
        layero.find("#modalOk").on("click", () => {
          const updatedItem = {
            ...aiFlower,
              ...
              aiFlowerTypeUuid: layero.find('input[name="aiFlowerTypeUuid"]').val(), 
  ...
  const handleCreate = () => {
    const newItem = { uuid: "",  aiFlowerName: "",  aiFlowerTypeUuid: "",  aiFlowerPrice: "", };
    ...
    layui.layer.open({
      ...
      success: function (layero, index) {
        ...
        layero.find("#modalOk").on("click", () => {
          ...
          const aiFlowerTypeUuid = layero.find('input[name="aiFlowerTypeUuid"]').val();
          const aiFlowerPrice = layero.find('input[name="aiFlowerPrice"]').val();
          setList([...list, { ...newItem, uuid: Date.now(), aiFlowerName,aiFlowerTypeUuid,aiFlowerPrice, }]);
          layui.layer.close(index);
        });
      },
    });
