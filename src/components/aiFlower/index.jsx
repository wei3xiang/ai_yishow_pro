...
const Index = () => {
        ...
        layero.find("#modalOk").on("click", () => {
          const updatedItem = {
            ...aiFlower,
              ...
              aiFlowerType: layero.find('input[name="aiFlowerType"]').val(), 
              aiFlowerPrice: layero.find('input[name="aiFlowerPrice"]').val(), 
              aiFlowerImgUrl: layero.find('input[name="aiFlowerImgUrl"]').val(), 
  ...
  const handleCreate = () => {
    const newItem = { uuid: "",  aiFlowerName: "",  aiFlowerType: "",  aiFlowerPrice: "",  aiFlowerImgUrl: "",  aiStockQuantity: "", };
    ...
    layui.layer.open({
      ...
      success: function (layero, index) {
        ...
        layero.find("#modalOk").on("click", () => {
          ...
          const aiFlowerType = layero.find('input[name="aiFlowerType"]').val();
          const aiFlowerPrice = layero.find('input[name="aiFlowerPrice"]').val();
          const aiFlowerImgUrl = layero.find('input[name="aiFlowerImgUrl"]').val();
          const aiStockQuantity = layero.find('input[name="aiStockQuantity"]').val();
          setList([...list, { ...newItem, uuid: Date.now(), aiFlowerName,aiFlowerType,aiFlowerPrice,aiFlowerImgUrl,aiStockQuantity, }]);
          layui.layer.close(index);
        });
      },
    });
