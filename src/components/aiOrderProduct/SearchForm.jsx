...
import { aiOrderProductStateAtom } from './atom';

const SearchForm = (props) => {
  const [form] = Form.useForm();
  const [aiOrderProductState, setAiOrderProductState] = useRecoilState(aiOrderProductStateAtom);
  ...
  const onClickToCreate = useCallback(() => {
    setAiOrderProductState((prevState) => ({
      ...prevState,
      createModel: {},
    }));
  }, []);
