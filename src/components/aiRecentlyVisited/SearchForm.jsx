...
import { aiRecentlyVisitedStateAtom } from './atom';

const SearchForm = (props) => {
  const [form] = Form.useForm();
  const [aiRecentlyVisitedState, setAiRecentlyVisitedState] = useRecoilState(aiRecentlyVisitedStateAtom);
  ...
  const onClickToCreate = useCallback(() => {
    setAiRecentlyVisitedState((prevState) => ({
      ...prevState,
      createModel: {},
    }));
  }, []);
