...
import { aiUserPaymentRecordsStateAtom } from './atom';

const SearchForm = (props) => {
  const [form] = Form.useForm();
  const [aiUserPaymentRecordsState, setAiUserPaymentRecordsState] = useRecoilState(aiUserPaymentRecordsStateAtom);
  ...
  const onClickToCreate = useCallback(() => {
    setAiUserPaymentRecordsState((prevState) => ({
      ...prevState,
      createModel: {},
    }));
  }, []);
