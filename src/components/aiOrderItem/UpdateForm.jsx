const UpdateForm = ({ aiOrderItem }) => {
  return `<div class="layui-form" style="padding: 20px;">
      ...
      <div class="layui-input-block">  
        <input type="text" name="aiInventoryUuid" value="${aiOrderItem.ai_inventory_uuid}" class="layui-input">  
      </div>  
    </div>  
      <div class="layui-form-item">  
      ...
      <div class="layui-input-block">  
        <input type="text" name="aiSubTotal" value="${aiOrderItem.ai_sub_total}" class="layui-input">  
      </div>  
    </div>  
  </div>  
