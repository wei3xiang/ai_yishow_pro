...
const Index = () => {
  ...
  const handleCreate = () => {
    const newItem = { uuid: "",  aiOrderUuid: "",  aiProductUuid: "",  aiQuantity: "",  aiItemPrice: "", };
    ...
    layui.layer.open({
      ...
      success: function (layero, index) {
        ...
        layero.find("#modalOk").on("click", () => {
          ...
          setList([...list, { ...newItem, uuid: Date.now(), aiOrderUuid,aiProductUuid,aiQuantity,aiItemPrice, }]);
          layui.layer.close(index);
        });
      },
    });
