...
const Index = () => {
  ...
  const handleCreate = () => {
    const newItem = { uuid: "",  aiOrderUuid: "",  aiProductUuid: "",  aiQuantity: "",  aiTotalPrice: "", };
    ...
    layui.layer.open({
      ...
      success: function (layero, index) {
        ...
        layero.find("#modalOk").on("click", () => {
          ...
          setList([...list, { ...newItem, uuid: Date.now(), aiOrderUuid,aiProductUuid,aiQuantity,aiTotalPrice, }]);
          layui.layer.close(index);
        });
      },
    });
