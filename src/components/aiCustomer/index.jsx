...
const Index = () => {
        ...
        layero.find("#modalOk").on("click", () => {
          const updatedItem = {
            ...aiCustomer,
              ...
              companyName: layero.find('input[name="companyName"]').val(), 
          };
          setList(
  ...
  const handleCreate = () => {
    const newItem = { uuid: "",  userUuid: "",  name: "",  companyName: "", };
    ...
    layui.layer.open({
      ...
      success: function (layero, index) {
        ...
        layero.find("#modalOk").on("click", () => {
          ...
          const companyName = layero.find('input[name="companyName"]').val();
          setList([...list, { ...newItem, uuid: Date.now(), userUuid,name,companyName, }]);
          layui.layer.close(index);
        });
      },
    });
