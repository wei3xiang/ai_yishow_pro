const UpdateForm = ({ aiCustomer }) => {
  return `<div class="layui-form" style="padding: 20px;">
      ...
      <div class="layui-input-block">  
        <input type="text" name="userUuid" value="${aiCustomer.user_uuid}" class="layui-input">  
      </div>  
    </div>  
      <div class="layui-form-item">  
      ...
      <div class="layui-input-block">  
        <input type="text" name="companyName" value="${aiCustomer.company_name}" class="layui-input">  
      </div>  
    </div>  
  </div>  
