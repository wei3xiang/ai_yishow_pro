  ...
  const filteredList = useMemo(() => {
    return data.filter(
      (aiCustomer) =>
       ...
       `${aiCustomer.ai_contact_phone}`.includes(searchTerm) ||
       `${aiCustomer.ai_contact_email}`.includes(searchTerm) ||
        ...
        <tbody>
          {filteredList.map((aiCustomer) => (
            <tr key={aiCustomer.uuid}>
              ...
              <td>{aiCustomer.ai_contact_phone}</td>
              <td>{aiCustomer.ai_contact_email}</td>
