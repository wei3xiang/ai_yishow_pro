const CreateForm = () => {
  return `  
      <div class="layui-form" style="padding: 20px;">  
            ...
            <div class="layui-input-block">  
                <input type="text" name="customer_email" placeholder="请输入客户电子邮箱"  class="layui-input">  
            </div>  
            </div>  
            <div class="layui-form-item">  
            ...
            <div class="layui-input-block">  
                <input type="text" name="customer_address" placeholder="请输入客户地址"  class="layui-input">  
            </div>  
            </div>  
      </div>  
