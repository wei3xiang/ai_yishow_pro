const CreateForm = () => {
  return `  
      <div class="layui-form" style="padding: 20px;">  
            ...
            <div class="layui-input-block">  
                <input type="text" name="inventory_date" placeholder="请输入库存日期"  class="layui-input">  
            </div>  
            </div>  
            <div class="layui-form-item">  
            <label class="layui-form-label">库存数量</label>  
            <div class="layui-input-block">  
                <input type="text" name="inventory_quantity" placeholder="请输入库存数量"  class="layui-input">  
            </div>  
            </div>  
      </div>  
