...
const Index = () => {
  ...
  const handleCreate = () => {
    const newItem = { uuid: "",  aiProductName: "",  aiProductType: "",  aiQuantity: "",  aiReorderLevel: "", };
    ...
    layui.layer.open({
      ...
      success: function (layero, index) {
        ...
        layero.find("#modalOk").on("click", () => {
          ...
          setList([...list, { ...newItem, uuid: Date.now(), aiProductName,aiProductType,aiQuantity,aiReorderLevel, }]);
          layui.layer.close(index);
        });
      },
    });
