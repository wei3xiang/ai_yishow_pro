...
const Index = () => {
        ...
        layero.find("#modalOk").on("click", () => {
          const updatedItem = {
            ...aiInventory,
              ...
              aiRestockThreshold: layero.find('input[name="aiRestockThreshold"]').val(), 
          };
          setList(
  ...
  const handleCreate = () => {
    const newItem = { uuid: "",  aiProductId: "",  aiProductName: "",  aiQuantity: "",  aiUnit: "",  aiRestockThreshold: "", };
    ...
    layui.layer.open({
      ...
      success: function (layero, index) {
        ...
        layero.find("#modalOk").on("click", () => {
          ...
          const aiRestockThreshold = layero.find('input[name="aiRestockThreshold"]').val();
          setList([...list, { ...newItem, uuid: Date.now(), aiProductId,aiProductName,aiQuantity,aiUnit,aiRestockThreshold, }]);
          layui.layer.close(index);
        });
      },
    });
