...
const Index = () => {
        ...
        layero.find("#modalOk").on("click", () => {
          const updatedItem = {
            ...aiInventory,
              ...
              aiManufacturer: layero.find('input[name="aiManufacturer"]').val(), 
              aiVolume: layero.find('input[name="aiVolume"]').val(), 
  ...
  const handleCreate = () => {
    const newItem = { uuid: "",  aiBeerName: "",  aiType: "",  aiManufacturer: "",  aiVolume: "",  aiQuantity: "",  aiPrice: "", };
    ...
    layui.layer.open({
      ...
      success: function (layero, index) {
        ...
        layero.find("#modalOk").on("click", () => {
          ...
          const aiManufacturer = layero.find('input[name="aiManufacturer"]').val();
          const aiVolume = layero.find('input[name="aiVolume"]').val();
          const aiQuantity = layero.find('input[name="aiQuantity"]').val();
          const aiPrice = layero.find('input[name="aiPrice"]').val();
          setList([...list, { ...newItem, uuid: Date.now(), aiBeerName,aiType,aiManufacturer,aiVolume,aiQuantity,aiPrice, }]);
          layui.layer.close(index);
        });
      },
    });
