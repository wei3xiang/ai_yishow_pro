...
const Index = () => {
        ...
        layero.find("#modalOk").on("click", () => {
          const updatedItem = {
            ...aiInventory,
              ...
              aiCostPrice: layero.find('input[name="aiCostPrice"]').val(), 
  ...
  const handleCreate = () => {
    const newItem = { uuid: "",  aiProductName: "",  aiStock: "",  aiCostPrice: "",  aiSalePrice: "", };
    ...
    layui.layer.open({
      ...
      success: function (layero, index) {
        ...
        layero.find("#modalOk").on("click", () => {
          ...
          const aiCostPrice = layero.find('input[name="aiCostPrice"]').val();
          const aiSalePrice = layero.find('input[name="aiSalePrice"]').val();
          setList([...list, { ...newItem, uuid: Date.now(), aiProductName,aiStock,aiCostPrice,aiSalePrice, }]);
          layui.layer.close(index);
        });
      },
    });
