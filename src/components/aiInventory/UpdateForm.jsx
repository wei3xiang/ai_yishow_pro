const UpdateForm = ({ aiInventory }) => {
  return `<div class="layui-form" style="padding: 20px;">
      ...
      <div class="layui-input-block">  
        <input type="text" name="aiSupplier" value="${aiInventory.aiSupplier}" class="layui-input">  
      </div>  
    </div>  
      <div class="layui-form-item">  
      <label class="layui-form-label">存储位置</label>  
      <div class="layui-input-block">  
        <input type="text" name="aiStorageLocation" value="${aiInventory.aiStorageLocation}" class="layui-input">  
      </div>  
    </div>  
  </div>  
