      ...
      <div class="layui-form" style="padding: 20px;">  
          <div class="layui-form-item">  
            ...
            <div class="layui-input-block">  
              <input type="text" name="aiProductUuid" value="${aiInventory.aiProductUuid}" class="layui-input" readonly>  
            </div>  
          </div>  
          <div class="layui-form-item">  
            <label class="layui-form-label">当前库存</label>  
            <div class="layui-input-block">  
              <input type="text" name="aiCurrentStock" value="${aiInventory.aiCurrentStock}" class="layui-input" readonly>  
            </div>  
          </div>  
          <div class="layui-form-item">  
