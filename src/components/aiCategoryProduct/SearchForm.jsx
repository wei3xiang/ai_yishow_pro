...
import { aiCategoryProductStateAtom } from './atom';

const SearchForm = (props) => {
  const [form] = Form.useForm();
  const [aiCategoryProductState, setAiCategoryProductState] = useRecoilState(aiCategoryProductStateAtom);
  ...
  const onClickToCreate = useCallback(() => {
    setAiCategoryProductState((prevState) => ({
      ...prevState,
      createModel: {},
    }));
  }, []);
