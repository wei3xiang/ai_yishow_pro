...
import { aiBeerCategoryStateAtom } from './atom';

const SearchForm = (props) => {
  const [form] = Form.useForm();
  const [aiBeerCategoryState, setAiBeerCategoryState] = useRecoilState(aiBeerCategoryStateAtom);
  ...
  const onClickToCreate = useCallback(() => {
    setAiBeerCategoryState((prevState) => ({
      ...prevState,
      createModel: {},
    }));
  }, []);
