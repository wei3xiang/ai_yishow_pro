...
import { aiProductCategoriesAssociationStateAtom } from './atom';

const SearchForm = (props) => {
  const [form] = Form.useForm();
  const [aiProductCategoriesAssociationState, setAiProductCategoriesAssociationState] = useRecoilState(aiProductCategoriesAssociationStateAtom);
  ...
  const onClickToCreate = useCallback(() => {
    setAiProductCategoriesAssociationState((prevState) => ({
      ...prevState,
      createModel: {},
    }));
  }, []);
