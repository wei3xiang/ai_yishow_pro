...
import { aiOrderDetailsStateAtom } from './atom';

const SearchForm = (props) => {
  const [form] = Form.useForm();
  const [aiOrderDetailsState, setAiOrderDetailsState] = useRecoilState(aiOrderDetailsStateAtom);
  ...
  const onClickToCreate = useCallback(() => {
    setAiOrderDetailsState((prevState) => ({
      ...prevState,
      createModel: {},
    }));
  }, []);
