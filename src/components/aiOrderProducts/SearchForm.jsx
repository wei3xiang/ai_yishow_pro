...
import { aiOrderProductsStateAtom } from './atom';

const SearchForm = (props) => {
  const [form] = Form.useForm();
  const [aiOrderProductsState, setAiOrderProductsState] = useRecoilState(aiOrderProductsStateAtom);
  ...
  const onClickToCreate = useCallback(() => {
    setAiOrderProductsState((prevState) => ({
      ...prevState,
      createModel: {},
    }));
  }, []);
