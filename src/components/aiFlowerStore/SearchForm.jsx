...
import { aiFlowerStoreStateAtom } from './atom';

const SearchForm = (props) => {
  const [form] = Form.useForm();
  const [aiFlowerStoreState, setAiFlowerStoreState] = useRecoilState(aiFlowerStoreStateAtom);
  ...
  const onClickToCreate = useCallback(() => {
    setAiFlowerStoreState((prevState) => ({
      ...prevState,
      createModel: {},
    }));
  }, []);
