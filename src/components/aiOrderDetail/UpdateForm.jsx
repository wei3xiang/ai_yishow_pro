const UpdateForm = ({ aiOrderDetail }) => {
  return `<div class="layui-form" style="padding: 20px;">
      ...
      <div class="layui-input-block">  
        <input type="text" name="aiFlowerCount" value="${aiOrderDetail.ai_flower_count}" class="layui-input">  
      </div>  
    </div>  
      <div class="layui-form-item">  
      <label class="layui-form-label">花朵总价</label>  
      <div class="layui-input-block">  
        <input type="text" name="aiFlowerTotalPrice" value="${aiOrderDetail.ai_flower_total_price}" class="layui-input">  
      </div>  
    </div>  
  </div>  
