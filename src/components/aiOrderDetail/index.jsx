...
const Index = () => {
        ...
        layero.find("#modalOk").on("click", () => {
          const updatedItem = {
            ...aiOrderDetail,
              ...
              aiSubTotalAmount: layero.find('input[name="aiSubTotalAmount"]').val(), 
  ...
  const handleCreate = () => {
    const newItem = { uuid: "",  aiOrderUuid: "",  aiItemName: "",  aiItemId: "",  aiQuantity: "",  aiUnitPrice: "",  aiSubTotalAmount: "",  aiCreationTime: "", };
    ...
    layui.layer.open({
      ...
      success: function (layero, index) {
        ...
        layero.find("#modalOk").on("click", () => {
          ...
          const aiSubTotalAmount = layero.find('input[name="aiSubTotalAmount"]').val();
          const aiCreationTime = layero.find('input[name="aiCreationTime"]').val();
          setList([...list, { ...newItem, uuid: Date.now(), aiOrderUuid,aiItemName,aiItemId,aiQuantity,aiUnitPrice,aiSubTotalAmount,aiCreationTime, }]);
          layui.layer.close(index);
        });
      },
    });
