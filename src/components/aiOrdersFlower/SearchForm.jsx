...
import { aiOrdersFlowerStateAtom } from './atom';

const SearchForm = (props) => {
  const [form] = Form.useForm();
  const [aiOrdersFlowerState, setAiOrdersFlowerState] = useRecoilState(aiOrdersFlowerStateAtom);
  ...
  const onClickToCreate = useCallback(() => {
    setAiOrdersFlowerState((prevState) => ({
      ...prevState,
      createModel: {},
    }));
  }, []);
