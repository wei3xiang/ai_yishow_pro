const UpdateForm = ({ aiShop }) => {
  return `<div class="layui-form" style="padding: 20px;">
      ...
      <div class="layui-input-block">  
        <input type="text" name="aiShopContact" value="${aiShop.ai_shop_contact}" class="layui-input">  
      </div>  
    </div>  
      <div class="layui-form-item">  
      ...
      <div class="layui-input-block">  
        <input type="text" name="aiShopEmail" value="${aiShop.ai_shop_email}" class="layui-input">  
      </div>  
    </div>  
  </div>  
