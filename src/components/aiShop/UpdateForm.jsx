const UpdateForm = ({ aiShop }) => {
  return `<div class="layui-form" style="padding: 20px;">
      ...
      <div class="layui-input-block">  
        <input type="text" name="aiLocation" value="${aiShop.ai_location}" class="layui-input">  
      </div>  
    </div>  
      <div class="layui-form-item">  
      <label class="layui-form-label">店铺负责人UUID</label>  
      <div class="layui-input-block">  
        <input type="text" name="aiOwnerUuid" value="${aiShop.ai_owner_uuid}" class="layui-input">  
      </div>  
    </div>  
  </div>  
