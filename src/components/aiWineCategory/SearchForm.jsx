...
import { aiWineCategoryStateAtom } from './atom';

const SearchForm = (props) => {
  const [form] = Form.useForm();
  const [aiWineCategoryState, setAiWineCategoryState] = useRecoilState(aiWineCategoryStateAtom);
  ...
  const onClickToCreate = useCallback(() => {
    setAiWineCategoryState((prevState) => ({
      ...prevState,
      createModel: {},
    }));
  }, []);
