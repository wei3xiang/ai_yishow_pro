...
import { aiBranchProductStateAtom } from './atom';

const SearchForm = (props) => {
  const [form] = Form.useForm();
  const [aiBranchProductState, setAiBranchProductState] = useRecoilState(aiBranchProductStateAtom);
  ...
  const onClickToCreate = useCallback(() => {
    setAiBranchProductState((prevState) => ({
      ...prevState,
      createModel: {},
    }));
  }, []);
