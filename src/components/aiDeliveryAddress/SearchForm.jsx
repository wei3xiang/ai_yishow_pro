...
import { aiDeliveryAddressStateAtom } from './atom';

const SearchForm = (props) => {
  const [form] = Form.useForm();
  const [aiDeliveryAddressState, setAiDeliveryAddressState] = useRecoilState(aiDeliveryAddressStateAtom);
  ...
  const onClickToCreate = useCallback(() => {
    setAiDeliveryAddressState((prevState) => ({
      ...prevState,
      createModel: {},
    }));
  }, []);
