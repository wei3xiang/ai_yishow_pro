...
const Index = () => {
        ...
        layero.find("#modalOk").on("click", () => {
          const updatedItem = {
            ...aiProduct,
              ...
              aiBrand: layero.find('input[name="aiBrand"]').val(), 
          };
          setList(
  ...
  const handleCreate = () => {
    const newItem = { uuid: "",  aiProductId: "",  aiProductName: "",  aiDescription: "",  aiStock: "",  aiCategory: "",  aiBrand: "", };
    ...
    layui.layer.open({
      ...
      success: function (layero, index) {
        ...
        layero.find("#modalOk").on("click", () => {
          ...
          const aiBrand = layero.find('input[name="aiBrand"]').val();
          setList([...list, { ...newItem, uuid: Date.now(), aiProductId,aiProductName,aiDescription,aiStock,aiCategory,aiBrand, }]);
          layui.layer.close(index);
        });
      },
    });
