...
const Index = () => {
  ...
  const handleCreate = () => {
    const newItem = { uuid: "",  aiName: "",  aiDescription: "",  aiPrice: "",  aiQuantity: "",  aiCategoryUuid: "", };
    ...
    layui.layer.open({
      ...
      success: function (layero, index) {
        ...
        layero.find("#modalOk").on("click", () => {
          ...
          setList([...list, { ...newItem, uuid: Date.now(), aiName,aiDescription,aiPrice,aiQuantity,aiCategoryUuid, }]);
          layui.layer.close(index);
        });
      },
    });
