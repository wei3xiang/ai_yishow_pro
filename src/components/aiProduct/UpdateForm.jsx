const UpdateForm = ({ aiProduct }) => {
  return `<div class="layui-form" style="padding: 20px;">
      ...
      <div class="layui-input-block">  
        <input type="text" name="aiCategoryId" value="${aiProduct.ai_category_id}" class="layui-input">  
      </div>  
    </div>  
      <div class="layui-form-item">  
      ...
      <div class="layui-input-block">  
        <input type="text" name="aiStatus" value="${aiProduct.ai_status}" class="layui-input">  
      </div>  
    </div>  
  </div>  
