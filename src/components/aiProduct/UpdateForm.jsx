const UpdateForm = ({ aiProduct }) => {
  return `<div class="layui-form" style="padding: 20px;">
      ...
      <div class="layui-input-block">  
        <input type="text" name="aiProductNumber" value="${aiProduct.ai_product_number}" class="layui-input">  
      </div>  
    </div>  
      <div class="layui-form-item">  
      ...
      <div class="layui-input-block">  
        <input type="text" name="aiImageUrl" value="${aiProduct.ai_image_url}" class="layui-input">  
      </div>  
    </div>  
      <div class="layui-form-item">  
      <label class="layui-form-label">花店编号</label>  
      <div class="layui-input-block">  
        <input type="text" name="aiShopNumber" value="${aiProduct.ai_shop_number}" class="layui-input">  
      </div>  
    </div>  
  </div>  
