  ...
  return `  
      <div class="layui-form" style="padding: 20px;">  
          ...
          <div class="layui-form-item">  
            ...
            <div class="layui-input-block">  
              <input type="text" name="productCategory" value="${aiProduct.product_category}" class="layui-input" readonly>  
            </div>  
          </div>  
          <div class="layui-form-item">  
            <label class="layui-form-label">商品图片地址</label>  
            <div class="layui-input-block">  
              <input type="text" name="productImage" value="${aiProduct.product_image}" class="layui-input" readonly>  
            </div>  
          </div>  
      </div>  
