      ...
      <div class="layui-form" style="padding: 20px;">  
          <div class="layui-form-item">  
            ...
            <div class="layui-input-block">  
              <input type="text" name="aiProductId" value="${aiProduct.ai_product_id}" class="layui-input" readonly>  
            </div>  
          </div>  
          <div class="layui-form-item">  
          ...
          <div class="layui-form-item">  
            ...
            <div class="layui-input-block">  
              <input type="text" name="aiBrand" value="${aiProduct.ai_brand}" class="layui-input" readonly>  
            </div>  
          </div>  
      </div>  
