  ...
  return `  
      <div class="layui-form" style="padding: 20px;">  
        ...
        <div class="layui-form-item">  
          ...
          <div class="layui-input-block">  
            <input type="text" value="${aiProduct.ai_store_uuid}" class="layui-input" readonly>  
          </div>  
        </div>
        <div class="layui-form-item">  
        ...
        <div class="layui-form-item">  
          ...
          <div class="layui-input-block">  
            <input type="text" value="${aiProduct.ai_product_price}" class="layui-input" readonly>  
          </div>  
        </div>
        <div class="layui-form-item">  
          <label class="layui-form-label">商品库存</label>  
          <div class="layui-input-block">  
            <input type="text" value="${aiProduct.ai_product_stock}" class="layui-input" readonly>  
          </div>  
        </div>
        </div>
