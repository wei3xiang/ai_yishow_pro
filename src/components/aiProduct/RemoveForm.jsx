      ...
      <div class="layui-form" style="padding: 20px;">  
        <div class="layui-form-item">  
          ...
          <div class="layui-input-block">  
            <input type="text" value="${aiProduct.ai_product_number}" class="layui-input" readonly>  
          </div>  
        </div>
        <div class="layui-form-item">  
        ...
        <div class="layui-form-item">  
          ...
          <div class="layui-input-block">  
            <input type="text" value="${aiProduct.ai_image_url}" class="layui-input" readonly>  
          </div>  
        </div>
        <div class="layui-form-item">  
          <label class="layui-form-label">花店编号</label>  
          <div class="layui-input-block">  
            <input type="text" value="${aiProduct.ai_shop_number}" class="layui-input" readonly>  
          </div>  
        </div>
        </div>
