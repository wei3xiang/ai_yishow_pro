...
import { aiSupplierStockStateAtom } from './atom';

const SearchForm = (props) => {
  const [form] = Form.useForm();
  const [aiSupplierStockState, setAiSupplierStockState] = useRecoilState(aiSupplierStockStateAtom);
  ...
  const onClickToCreate = useCallback(() => {
    setAiSupplierStockState((prevState) => ({
      ...prevState,
      createModel: {},
    }));
  }, []);
