...
import { aiProductStockStateAtom } from './atom';

const SearchForm = (props) => {
  const [form] = Form.useForm();
  const [aiProductStockState, setAiProductStockState] = useRecoilState(aiProductStockStateAtom);
  ...
  const onClickToCreate = useCallback(() => {
    setAiProductStockState((prevState) => ({
      ...prevState,
      createModel: {},
    }));
  }, []);
