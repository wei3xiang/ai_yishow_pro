const CreateForm = () => {
  return `  
      <div class="layui-form" style="padding: 20px;">  
            ...
            <div class="layui-input-block">  
                <input type="text" name="ai_current_quantity" placeholder="请输入当前库存"  class="layui-input">  
            </div>  
            </div>  
            <div class="layui-form-item">  
            <label class="layui-form-label">最低库存</label>  
            <div class="layui-input-block">  
                <input type="text" name="ai_minimum_quantity" placeholder="请输入最低库存"  class="layui-input">  
            </div>  
            </div>  
      </div>  
